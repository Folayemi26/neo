...
- ✅ Fixed hardcoded `localhost:4000` references in:
  - `neo-dashboard/src/api/helpRequestApi.js`
  - `neo-dashboard/src/api/firstAidApi.js`
  - `neo-dashboard/src/api/rescueApi.js`
  - `neo-dashboard/src/api/peerApi.js`
  - `neo-dashboard/src/pages/FindShelter.jsx`
  - `neo-dashboard/src/pages/DisasterManagement.jsx`
  - `neo-dashboard/src/pages/LocationUpdates.jsx`
  - `neo-dashboard/src/components/common/ConnectionStatus.jsx`
